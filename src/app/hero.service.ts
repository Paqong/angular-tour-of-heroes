...
export class HeroService {
  ...
  /** GET heroes from the server using HTTP with error handling*/
  getHeroes(): Observable<Hero[]> {
  ...
  private handleError<T>(operation = 'operation', result?: T) {
    return (error: any): Observable<T> => {
      ...
      // Keeps the app running by returning an empty result.
   ...
   * It expects the server to create an id for the new hero, 
